...
function create_barang($post)
{
    ...
    //query tambah data
    $query = "INSERT INTO barang VALUE(null, '$nama', '$jumlah', '$harga', '$barcode',  CURRENT_TIMESTAMP())";
...
// fungsi mengahapus data mahasiswa
